...
[course-example-website](https://github.com/kgsi/course-example-website)では、以下のパッケージをインストールしています。
...
- [course-example-website](https://github.com/kgsi/course-example-website)をforkします。
- リポジトリのfork方法については[リポジトリをフォークする - GitHub Docs](https://docs.github.com/ja/get-started/quickstart/fork-a-repo)を確認してください。
